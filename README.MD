...
running a psring boot maven target. JQ
...
* Maven project reports
    ...
    13. Tag List - TODO and Fixme occurances
...
# Get the app info - returns empty
curl -v localhost:8000/actuator/info

# Get the app metrics - returns error
